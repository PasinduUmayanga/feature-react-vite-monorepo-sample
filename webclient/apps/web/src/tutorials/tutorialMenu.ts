...
export const tutorialMenu: readonly TutorialMenuFolder[] = [{
  ...
  children: [
    ...
    { label: 'packages', description: 'Reusable APIs consumed through workspace package names.', children: [
      'shared-ui', 'hooks', 'utilities', 'api-client', 'auth', 'config',
      { label: 'features', description: 'Feature-owned server-state and domain boundaries.', children: ['users-feature', 'reports-feature'] },
      'eslint-config',
    ] },
