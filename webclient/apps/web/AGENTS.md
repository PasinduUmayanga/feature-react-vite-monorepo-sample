...
- `src/pages/MonorepoTutorialPage.tsx` is the public implementation tutorial for this monorepo. Keep its examples, hash-routed lesson views, and table of contents synchronized with meaningful architecture, workflow, API, package, and user-visible feature changes.
